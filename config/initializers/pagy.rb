...
# TODO: make this separately configurable for main site and admin area
Pagy::VARS[ :items ] = 20
...
# Uses the standard i18n gem which is ~18x slower using ~10x more memory than the pagy internal i18n (see above)
