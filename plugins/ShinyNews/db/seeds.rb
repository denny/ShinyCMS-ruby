...
# Add feature flag
news_flag = FeatureFlag.find_or_create_by!( name: 'shiny_news' )
news_flag.update!(
...
news_votes_flag = FeatureFlag.find_or_create_by!( name: 'shiny_news_votes' )
...
news_downvotes_flag = FeatureFlag.find_or_create_by!( name: 'shiny_news_downvotes' )
