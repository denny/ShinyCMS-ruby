...
# File:      plugins/ShinyNews/lib/shiny_news/engine.rb
# Purpose:   Loads Rails::Engine functionality
#
...
module ShinyNews
  ...
  class Engine < ::Rails::Engine
    ...
    initializer 'shiny_news.factories', after: 'factory_bot.set_factory_paths' do
