# ShinyBlogs: multi-blog plugin for ShinyCMS

ShinyBlogs is a plugin for [ShinyCMS](https://shinycms.com) which adds
the ability to host multiple blogs on your ShinyCMS website.


## Installation

Add 'ShinyBlogs' to the SHINYCMS_PLUGINS ENV var, then
...
To add the ShinyBlogs tables and supporting data to your
ShinyCMS database:
```bash
