...
Devise.setup do |config|
  ...
  # config.secret_key = 'abcd1234abcd1234abcd1234abcd1234abcd1234abcd1234abcd'
  #   + '1234abcd1234abcd1234abcd1234abcd1234abcd1234abcd1234abcd1234abcd1234'

  # ==> Controller configuration
  # Configure the parent class to the devise controllers.
  # config.parent_controller = 'DeviseController'
  config.parent_controller = 'ShinyCMS::Users::BaseController'
  ...
  config.mailer = 'ShinyCMS::UserMailer'

  # Configure the parent class responsible to send e-mails.
  # config.parent_mailer = 'ActionMailer::Base'
  config.parent_mailer = 'ShinyCMS::ApplicationMailer'
  ...
  # [:database]` will enable it only for database (email + password) auth.
  ...
  # config.pepper = 'abcd1234abcd1234abcd1234abcd1234abcd1234abcd1234abcd1234'
  ...
  # :time  = Re-enables login after a specified delay (see :unlock_in below)
  ...
  # :clearance_sha1, :authlogic_sha512 (then you should set stretches above 20
  ...
  # change the failure app, you can configure them in the config.warden block.
  #
  ...
  # When using Devise inside an engine, and this engine is mountable, there are
  # some extra configurations to be taken into account.
