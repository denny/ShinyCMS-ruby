...
FileUtils.cp_r 'plugins/ShinyCMS/spec/fixtures/TEST', test_theme unless Dir.exist? test_theme
...
RSpec.configure do |config|
  ...
  config.after( :suite ) do
    ...
    FileUtils.rm_rf test_theme if ENV[ 'TEST_ENV_NUMBER' ].nil? && Dir.exist?( test_theme )
  end
end
