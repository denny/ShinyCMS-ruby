...
ShinyPages::Page.create!([
  ...
  {id: 3, internal_name: "Right sidebar", public_name: "Right Sidebar", slug: "right-sidebar", description: "", template_id: 3, section_id: 1, position: 2, show_in_menus: true, show_on_site: true},
