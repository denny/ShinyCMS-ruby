...
ShinyPages::TemplateElement.create!([
  ...
  {id: 2, template_id: 1, name: "banner_button_url", content: "", element_type: "Short Text", position: 2},
  {id: 3, template_id: 1, name: "banner_button_text", content: "", element_type: "Short Text", position: 3},
  ...
  {id: 6, template_id: 1, name: "heading1", content: "", element_type: "Short Text", position: 6},
  {id: 7, template_id: 1, name: "paragraph1", content: "", element_type: "Long Text", position: 7},
  {id: 8, template_id: 1, name: "image2", content: "", element_type: "Image", position: 8},
  {id: 9, template_id: 1, name: "heading2", content: "", element_type: "Short Text", position: 9},
  {id: 10, template_id: 1, name: "paragraph2", content: "", element_type: "Long Text", position: 10},
  {id: 11, template_id: 1, name: "image3", content: "", element_type: "Image", position: 11},
  {id: 12, template_id: 1, name: "heading3", content: "", element_type: "Short Text", position: 12},
  {id: 13, template_id: 1, name: "paragraph3", content: "", element_type: "Long Text", position: 13},
  {id: 14, template_id: 1, name: "image4", content: "", element_type: "Image", position: 14},
  {id: 15, template_id: 1, name: "heading4", content: "", element_type: "Short Text", position: 15},
  {id: 16, template_id: 1, name: "paragraph4", content: "", element_type: "Long Text", position: 16},
  ...
  {id: 21, template_id: 2, name: "heading", content: nil, element_type: "Short Text", position: 1},
  {id: 22, template_id: 2, name: "subheading", content: nil, element_type: "Short Text", position: 2},
  {id: 23, template_id: 2, name: "text_content", content: nil, element_type: "Long Text", position: 3},
  {id: 24, template_id: 3, name: "heading", content: nil, element_type: "Short Text", position: 1},
  {id: 25, template_id: 3, name: "subheading", content: nil, element_type: "Short Text", position: 2},
  {id: 26, template_id: 3, name: "text_content", content: nil, element_type: "Long Text", position: 3},
  {id: 27, template_id: 4, name: "heading", content: nil, element_type: "Short Text", position: 1},
  {id: 28, template_id: 4, name: "subheading", content: nil, element_type: "Short Text", position: 2},
  {id: 29, template_id: 4, name: "text_content", content: nil, element_type: "Long Text", position: 3},
  {id: 30, template_id: 5, name: "heading", content: nil, element_type: "Short Text", position: 1},
  {id: 31, template_id: 5, name: "subheading", content: nil, element_type: "Short Text", position: 2},
  {id: 32, template_id: 5, name: "text_content", content: nil, element_type: "Long Text", position: 3}
])

ShinyBlogs::Blog.create!([
...
ShinyPages::PageElement.create!([
  ...
  {id: 2, page_id: 1, name: "banner_button_url", content: "https://github.com/denny/ShinyCMS-ruby", element_type: "Short Text", position: 2},
  {id: 3, page_id: 1, name: "banner_button_text", content: "ShinyCMS on GitHub", element_type: "Short Text", position: 3},
  ...
  {id: 6, page_id: 1, name: "heading1", content: "Pages", element_type: "Short Text", position: 6},
  {id: 7, page_id: 1, name: "paragraph1", content: "Template-drive brochure pages with a simple, easy to use admin interface - safely edit the content areas without any risk of disturbing the page layout. Can be organised into nested sections for larger, more complicated sites.", element_type: "Long Text", position: 7},
  {id: 8, page_id: 1, name: "image2", content: "blog.png", element_type: "Image", position: 8},
  {id: 9, page_id: 1, name: "heading2", content: "Blog", element_type: "Short Text", position: 9},
  {id: 10, page_id: 1, name: "paragraph2", content: "Add posts now, backdate them, or schedule them to appear in the future. Hide/show/edit/delete posts. Decide whether to allow/disable discussion feature (comments) by default, overridable on a per-post basis.", element_type: "Long Text", position: 10},
  {id: 11, page_id: 1, name: "image3", content: "nested-comments.png", element_type: "Image", position: 11},
  {id: 12, page_id: 1, name: "heading3", content: "Discussions / Comments", element_type: "Short Text", position: 12},
  {id: 13, page_id: 1, name: "paragraph3", content: "Currently enabled on blog posts and news posts, but can be added to any type of content. Show/hide and lock/unlock whole discussions or individual comments.", element_type: "Long Text", position: 13},
  {id: 14, page_id: 1, name: "image4", content: "spam-comment-moderation.png", element_type: "Image", position: 14},
  {id: 15, page_id: 1, name: "heading4", content: "Anti-spam features", element_type: "Short Text", position: 15},
  {id: 16, page_id: 1, name: "paragraph4", content: "Uses reCAPTCHA to detect and block bots. Uses Akismet to flag and hide potential spam comments. Moderation queue for flagged comments, with decisions fed back to Akismet to improve their accuracy.", element_type: "Long Text", position: 16},
  ...
  {id: 21, page_id: 2, name: "heading", content: "", element_type: "Short Text", position: 1},
  {id: 22, page_id: 2, name: "subheading", content: "", element_type: "Short Text", position: 2},
  {id: 23, page_id: 2, name: "text_content", content: "", element_type: "Long Text", position: 3},
  {id: 24, page_id: 3, name: "heading", content: "", element_type: "Short Text", position: 1},
  {id: 25, page_id: 3, name: "subheading", content: "", element_type: "Short Text", position: 2},
  {id: 26, page_id: 3, name: "text_content", content: "", element_type: "Long Text", position: 3},
  {id: 27, page_id: 4, name: "heading", content: "", element_type: "Short Text", position: 1},
  {id: 28, page_id: 4, name: "subheading", content: "", element_type: "Short Text", position: 2},
  {id: 29, page_id: 4, name: "text_content", content: "", element_type: "Long Text", position: 3},
  {id: 30, page_id: 5, name: "heading", content: "", element_type: "Short Text", position: 1},
  {id: 31, page_id: 5, name: "subheading", content: "", element_type: "Short Text", position: 2},
  {id: 32, page_id: 5, name: "text_content", content: "", element_type: "Long Text", position: 3}
])
