...
The current version of ShinyCMS runs on Ruby 3.1 and Rails 7.0
...
ShinyCMS requires Ruby 3.1 and Rails 7.0 or later. The project generally uses the most recent stable release of both Ruby and Rails (currently Ruby 3.1.6 and Rails 7.0.8.7).
