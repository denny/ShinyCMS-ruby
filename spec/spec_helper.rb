...
# Make tests go through the theme code
orig_theme = ENV['SHINYCMS_THEME']
test_theme = 'app/views/themes/TEST'
ENV['SHINYCMS_THEME'] = 'TEST'
FileUtils.cp_r 'spec/fixtures/TEST', test_theme unless Dir.exist? test_theme
